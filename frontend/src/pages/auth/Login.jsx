      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Access your campus operations hub
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-medium py-3 px-4 rounded-xl shadow-lg shadow-indigo-600/20 hover:shadow-indigo-600/30 transition-all duration-150 flex justify-center items-center gap-2 cursor-pointer disabled:opacity-50"
          >
            {loading ? (
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-slate-400">
            ...
            <Link to="/register" className="text-indigo-400 hover:underline hover:text-indigo-300">
              Create an account
            </Link>
          </p>
        </div>
